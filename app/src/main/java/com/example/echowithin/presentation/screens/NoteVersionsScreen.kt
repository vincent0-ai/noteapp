                        ...
                        Column(
                            ...
                            Row(
                                ...
                                Surface(
                                    ...
                                    color = if (version.is_proposal) BrandAmber.copy(alpha = 0.1f) else BrandOrange.copy(alpha = 0.1f),
                                    border = BorderStroke(1.dp, if (version.is_proposal) BrandAmber else BrandOrange)
                                ) {
                                    Text(
                                        ...
                                        color = if (version.is_proposal) BrandAmber else BrandOrange
                                    )
                                }
                            }
